...
export const questions: Question[] = [
  ...
  },
  {
    id: "q2",
    category: "กรอบความคิดและภาพรวมนิสัยทั้ง7",
    q: "2. ทำไมเราควรทำให้ทุกวันของชีวิตมีความหมาย ส่งผลดีกับชีวิตเรายังไง? (เขียนมา 3 อย่าง)",
    minItems: 3,
    minChars: 60,
  },
  {
    id: "q3",
    category: "กรอบความคิดและภาพรวมนิสัยทั้ง7",
    q: "3. ในเงินสี่ด้าน (ESBI) ทำไมเราต้องสร้างรายได้ทั้ง 2 ฝั่ง (ซ้ายและขวา) ถ้าสร้างฝั่งใดฝั่งหนึ่งอย่างเดียว ส่งผลเสียกับชีวิตเรายังไง? (เขียนมา 3 อย่าง)",
    minItems: 3,
    minChars: 80,
  },
  {
  ...
  { id: "q8", category: "กรอบความคิดและภาพรวมนิสัยทั้ง7", q: "8. ความรู้เรื่องเลนส์คนละสี ผู้เขียนต้องการให้เรารู้อะไร เอาความรู้นี้ไปใช้กับชีวิตเราอย่างไร?", minChars: 40 },
  { id: "q9", category: "กรอบความคิดและภาพรวมนิสัยทั้ง7", q: "9. ภาพหญิงสาวกับหญิงชรา ผู้เขียนต้องการให้เรารู้อะไร เอาความรู้นี้ไปใช้กับชีวิตเราอย่างไร?", minChars: 40 },
  ...
  { id: "q11", category: "กรอบความคิดและภาพรวมนิสัยทั้ง7", q: "11. ทำไมบางคนมีความรู้มากมายแต่ยังเอาตัวไม่รอด?", minChars: 40 },
  {
    id: "q12",
    category: "กรอบความคิดและภาพรวมนิสัยทั้ง7",
    q: '12. "หลักการ" คืออะไร? สำคัญกับชีวิตอย่างไร?',
    minItems: 3,
    minChars: 70,
  },
