/*
  ...
  - Changed the type of `answersJson` on the `Response` table. No cast exists, the column would be dropped and recreated, which cannot be done if there is data, since the column is required.
...
ADD COLUMN     "answersJson" JSONB NOT NULL,
ALTER COLUMN "formId" SET DEFAULT 'mrich-assessment-v1';
